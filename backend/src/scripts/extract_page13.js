...
async function main() {
  ...
  try {
    const result = await visionCompletion({
      system: "You are an assistant designed to extract all text, pricing tables, product details, packaging specifications, and specifications from vending machine consumables brochures. Extract every single line of text, columns, rates, and pack descriptions accurately.",
