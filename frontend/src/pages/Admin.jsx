...
export default function Admin() {
  ...
  async function onInvite(e) {
    ...
    try {
      ...
      setOkMsg(`${inviteName} added. They can log in with email "${inviteEmail}" and a 6-digit OTP.`);
      setInviteEmail('');
      setInviteName('');
      setInviteRole('staff');
      await load();
    ...
    <div className="space-y-6">
      ...
      <div className="card">
        ...
        <p className="text-xs text-slate-500 mb-4">
          Creates their account instantly. They sign in with their company email and a 6-digit OTP.
        </p>
