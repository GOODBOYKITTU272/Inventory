  ...
  return (
    ...
    >
      <div className="pt-3 mt-3 border-t border-slate-100 space-y-3">
        ...
        {rating > 0 && (
          <div className="text-center text-xs font-bold text-brand">{rating}/10</div>
        )}
        <textarea
          ...
          bookings.map((b, i) => {
            ...
            return (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-right shrink-0">
                    {b.rating ? (
                      ...
                      <button
                        onClick={() => setRatingOpen(ratingOpen === b.meal_date ? null : b.meal_date)}
                ...
                {b.rating && b.feedback && (
                  <div className="mt-2 ml-[68px] text-[11px] text-slate-500 italic">&ldquo;{b.feedback}&rdquo;</div>
                )}
                  ...
                  {ratingOpen === b.meal_date && !b.rating && (
                    <MealRatingInline
                      ...
                      onRated={() => {
                        ...
                        // Refresh bookings
                        api.myMealBookings(selectedMonth)
                          .then((data) => setBookings((data || []).sort((a, bb) => bb.meal_date.localeCompare(a.meal_date))))
                          .catch(() => {});
                      }}
                    />
                  )}
