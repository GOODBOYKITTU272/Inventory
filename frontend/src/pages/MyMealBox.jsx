      ...
      <div style={{ maxWidth: 480, margin: '0 auto' }}>
        <button
          ...
          style={{
            ...
            color: '#64748B', fontSize: 13, fontWeight: 500, marginBottom: 20, padding: 0,
          }}
        >
              ...
              <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    {booking.token_number ? (
                      <div style={{ textAlign: 'right' }}>
                        <div style={{ fontSize: 10, fontWeight: 600, color: '#94A3B8', textTransform: 'uppercase', letterSpacing: 1 }}>
                          Token #
                        </div>
                        <div style={{
                          fontSize: 16, fontWeight: 800, color: '#0F172A',
                          fontFamily: 'monospace', letterSpacing: 0.5, marginTop: 4,
                        }}>
                          {booking.token_number}
                        </div>
                      </div>
                ...
                <div style={{ padding: '20px 24px' }}>
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 20 }}>
                    ...
                    <div>
                      <div style={{ fontSize: 10, fontWeight: 600, color: '#94A3B8', textTransform: 'uppercase', letterSpacing: 1 }}>Lunch Time</div>
                      <div style={{ fontSize: 14, fontWeight: 600, color: '#0F172A', marginTop: 4 }}>1:00 PM</div>
                    </div>
                    <div>
                      <div style={{ fontSize: 10, fontWeight: 600, color: '#94A3B8', textTransform: 'uppercase', letterSpacing: 1 }}>Cabin</div>
                      <div style={{ fontSize: 14, fontWeight: 600, color: '#0F172A', marginTop: 4 }}>
                        {booking.cabin_name || '—'}
                      </div>
                    </div>
                    <div>
                      <div style={{ fontSize: 10, fontWeight: 600, color: '#94A3B8', textTransform: 'uppercase', letterSpacing: 1 }}>Print Status</div>
                      ...
                      {data?.canReprint ? (
                        <button
                          ...
                          style={{
                            ...
                            fontSize: 14, fontWeight: 700, cursor: printing ? 'not-allowed' : 'pointer',
                            display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
                            transition: 'all 0.2s',
                          }}
                        >
                          {printing
                            ? <><RefreshCw size={16} style={{ animation: 'spin 1s linear infinite' }} /> Sending to Printer...</>
                            : <><Printer size={16} /> {isDuplicate ? 'Reprint Token Again' : 'Reprint My Token'}</>}
                        </button>
                      ) : (
                        <div style={{
