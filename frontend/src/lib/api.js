...
export const api = {
  ...
  createConversionMaster: (body) => request('/api/bills/conversion-master', { method: 'POST', body: JSON.stringify(body) }),
  updateBillItemConversion: (id, body) => request(`/api/bills/items/${id}/conversion`, { method: 'PATCH', body: JSON.stringify(body) }),
